...
#         file_name = Checker.take_pic(report, item)
#         if file_name:
...
#
# if file_name: html = '<div><img src="%s" alt="screenshot" style="width: 300px; height: 200px" onclick="window.open(
# ' \ 'this.src)" align="right">/></div>'%file_name extra.append(pytest_html.extras.html(html)) report.extra = extra
