...
def test_demo(browser):
    ...
    ##################
    run.button("xpath", "//button[normalize-space()='Try it']")
    ...
    run.button("xpath", "//p[@id='demo']//input[@type='checkbox']")
    run.button("xpath", "//p[@id='demo2']//input[@type='checkbox']")
    ...
    run.button("xpath", "//a[normalize-space()='Link 1']")
    run.goto("http://127.0.0.1:5500/sample.html")
